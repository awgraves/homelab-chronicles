...
I download the [Debian network installer ISO file](https://www.debian.org/CD/netinst/) to my laptop, which is another refurbished ebay purchase: a Thinkpad X1 Carbon Gen 9 running [Omarchy Linux](https://omarchy.org/) (btw).
...
From here I select the USB drive as the boot option and enter the Debian installer.
